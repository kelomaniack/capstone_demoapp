...
require "rails-assets-ng-file-upload"
...
module RailsAssetsNgFileUploadShim
  ...
  def self.gem_spec
    Gem::Specification::load(
      gem_path.join("rails-assets-ng-file-upload-shim.gemspec").to_s
    )
  end
...
RailsAssets.components << RailsAssetsNgFileUploadShim
