...
Gem::Specification.new do |spec|
  ...
  spec.description   = "Lightweight Angular JS directive to upload files. Support drag&drop, paste image, progress and abort"
  spec.summary       = "Lightweight Angular JS directive to upload files. Support drag&drop, paste image, progress and abort"
