# -*- encoding: utf-8 -*-
# stub: rails-assets-ng-token-auth 0.0.27 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rails-assets-angular-cookie>, [">= 4.0.6"])
      s.add_development_dependency(%q<bundler>, ["~> 1.3"])
      s.add_development_dependency(%q<rake>, [">= 0"])
    else
      s.add_dependency(%q<rails-assets-angular>, [">= 1.2.0"])
      s.add_dependency(%q<rails-assets-angular-cookie>, [">= 4.0.6"])
